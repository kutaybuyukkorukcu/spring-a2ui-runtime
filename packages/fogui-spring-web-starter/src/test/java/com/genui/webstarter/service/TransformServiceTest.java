package com.genui.webstarter.service;
...
import com.genui.webstarter.prompt.TransformPromptProvider;
import com.genui.webstarter.runtime.FogUiTransformRuntime;
...
class TransformServiceTest {
    ...
    @Test
    @DisplayName("transform should phrase preferred components as canonical component types in the prompt context")
    void transformShouldPhrasePreferredComponentsAsCanonicalComponentTypesInThePromptContext() {
        ...
        assertTrue(contextHints.contains("Preferred UI component families (map these to componentType, not the top-level type): chart, table."));
    ...
    void transformShouldThrowParseFailureWhenEntityReturnsNull() {
        ...
        TransformExecutionException exception = assertThrows(
