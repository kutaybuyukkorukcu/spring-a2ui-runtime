...
class A2UiActionServiceTest {
    ...
    void shouldRouteSupportedUserActionAndReturnMessages() {
        A2UiActionService service = new A2UiActionService(List.of(new A2UiActionHandler() {
            @Override
            public boolean supports(A2UiUserAction userAction) {
                return "booking".equals(userAction.getSurfaceId()) && "confirm".equals(userAction.getName());
            }

            @Override
            public List<A2UiMessage> handle(A2UiUserAction userAction, String requestId) {
                return List.of(A2UiMessage.builder()
                        .deleteSurface(A2UiMessage.DeleteSurface.builder()
        ...
        A2UiClientEvent event = A2UiClientEvent.builder()
    ...
    void shouldRejectUnhandledUserActionRoutes() {
        ...
        A2UiActionException exception = assertThrows(A2UiActionException.class, () -> service.handleClientEvent(event, "req-action-3"));
