...
/**
 * Request body for the /a2ui/transform endpoint. Accepts raw LLM output and optional context hints.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class TransformRequest {
  ...
  /** The raw LLM response text to transform into structured UI. Required field. */
