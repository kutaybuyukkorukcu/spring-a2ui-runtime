...
public class TransformResponse {
  ...
  public static class TransformUsage {
    ...
    public TransformUsage(
        int transformTokens, String model, BigDecimal estimatedCost, long processingTimeMs) {
  ...
  public static TransformResponse success(
      GenerativeUIResponse result, TransformUsage usage, String requestId) {
  ...
  public static TransformResponse error(
      String message, String errorCode, Object errorDetails, String requestId) {
    TransformResponse response = new TransformResponse();
