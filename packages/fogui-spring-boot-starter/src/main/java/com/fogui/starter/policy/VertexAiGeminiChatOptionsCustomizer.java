...
public class VertexAiGeminiChatOptionsCustomizer implements FogUiChatOptionsCustomizer {
    ...
    public @NonNull ChatOptions customize(@Nullable ChatOptions incomingOptions, @NonNull FogUiGenerationPolicy policy) {
        VertexAiGeminiChatOptions options = incomingOptions instanceof VertexAiGeminiChatOptions vertexAiGeminiChatOptions
        ...
        if (policy.getResponseFormat() == FogUiGenerationPolicyProperties.ResponseFormatMode.JSON_OBJECT) {
