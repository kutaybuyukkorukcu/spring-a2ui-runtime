...
public class AzureOpenAiChatOptionsCustomizer implements FogUiChatOptionsCustomizer {
    ...
    public @NonNull ChatOptions customize(@Nullable ChatOptions incomingOptions, @NonNull FogUiGenerationPolicy policy) {
        AzureOpenAiChatOptions options = incomingOptions instanceof AzureOpenAiChatOptions azureOpenAiChatOptions
    ...
    private AzureOpenAiResponseFormat toResponseFormat(@Nullable FogUiGenerationPolicyProperties.ResponseFormatMode responseFormatMode) {
        ...
        throw new IllegalArgumentException("Unsupported Azure OpenAI response format mode: " + responseFormatMode);
    }
}