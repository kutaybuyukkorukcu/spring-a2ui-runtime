...
public class OpenAiChatOptionsCustomizer implements FogUiChatOptionsCustomizer {
  ...
  public boolean supports(
    ...
    return supportsProvider(
        FogUiProviderType.OPENAI, providerType, incomingOptions, OpenAiChatOptions.class);
  }
  ...
  public @NonNull ChatOptions customize(
    ...
    OpenAiChatOptions options =
        incomingOptions instanceof OpenAiChatOptions openAiChatOptions
  ...
  private ResponseFormat toResponseFormat(
    ...
    throw new IllegalArgumentException(
        "Unsupported OpenAI response format mode: " + responseFormatMode);
  }
}
