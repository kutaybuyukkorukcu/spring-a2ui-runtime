...
class DeterministicOptionsAdvisorTest {
    ...
    void shouldApplyDeterministicOptionsForCallPath() {
        ...
        OpenAiChatOptions options = (OpenAiChatOptions) Objects.requireNonNull(
            Objects.requireNonNull(Objects.requireNonNull(chain.getCapturedRequest()).prompt()).getOptions());
    ...
    private DeterministicOptionsAdvisor newAdvisor(FogUiGenerationPolicyProperties properties) {
        FogUiChatOptionsPolicyApplier policyApplier = new FogUiChatOptionsPolicyApplier(
    ...
    private static final class FixedStreamChain implements StreamAdvisorChain {
        ...
        @Override
        public @NonNull Flux<ChatClientResponse> nextStream(@NonNull ChatClientRequest chatClientRequest) {
            this.capturedRequest = chatClientRequest;
