...
class StreamPatchReconcilerTest {
  ...
  void shouldDefensivelyCopyIncomingMetadataWhenNormalizingFirstSnapshot() {
    ...
    GenerativeUIResponse incoming = GenerativeUIResponse.builder().metadata(metadata).build();
  ...
  void shouldKeepPreviousBlocksWhenIncomingPatchHasEmptyArrays() {
    ...
    GenerativeUIResponse incoming =
        GenerativeUIResponse.builder().thinking(List.of()).content(List.of()).build();
  ...
  void shouldPreferIncomingWhenIncomingPatchContainsConcreteValues() {
    GenerativeUIResponse previous =
        GenerativeUIResponse.builder().content(List.of(ContentBlock.text("old-content"))).build();

    GenerativeUIResponse incoming =
        GenerativeUIResponse.builder().content(List.of(ContentBlock.text("new-content"))).build();
