...
public class FogUiCanonicalValidator {
  ...
  public List<CanonicalValidationError> validate(
      GenerativeUIResponse response, CanonicalValidationContext context) {
  ...
  private void validateBlock(
      ContentBlock block, String path, List<CanonicalValidationError> errors) {
    if (block == null) {
  ...
  private void validateTextBlock(
      ContentBlock block, String path, List<CanonicalValidationError> errors) {
  ...
  private void validateComponentBlock(
      ContentBlock block, String path, List<CanonicalValidationError> errors) {
  ...
  private CanonicalValidationError error(
      String path, FogUiErrorCode code, String message, Map<String, Object> details) {
